...
function file_get_contents_async(string $filename, callable $cb, int $offset = 0, int $maxlen = null): bool {}
function file_put_contents_async(string $filename, string $data, callable $cb, int $flags = 0): bool {}
